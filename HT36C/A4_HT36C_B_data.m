function T = A4_HT36C_B_data()
    ...
    T.add('Uncertainty in Measured Overall Heat Transfer Coefficient', 'dUmeas', ...
        ...
        ) .* strcmp(string(T.flowDir), "Countercurrent")...
        + sqrt(...
            (-(T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho)) - (T.FHot.*cpH.*rhoH.*(Thi - Tho))./(DiH.*L.*pi.*(Tco - Tho).*(Tci - Tco - Thi + Tho)) - (T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho).^2)).^2 .* dTho.^2 ...
            +((T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho)) + (T.FHot.*cpH.*rhoH.*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Thi).*(Tci - Tco - Thi + Tho)) + (T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho).^2)).^2 .* dThi.^2 ...
            +(- (T.FHot.*cpH.*rhoH.*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Thi).*(Tci - Tco - Thi + Tho)) - (T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho).^2)).^2 .* dTci.^2 ...
            +((T.FHot.*cpH.*rhoH.*(Thi - Tho))./(DiH.*L.*pi.*(Tco - Tho).*(Tci - Tco - Thi + Tho)) + (T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho).^2)).^2 .* dTco.^2 ...
            +((cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho))).^2 .* dF.^2 ...
            +((T.FHot.*cpH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho))).^2 .* drhoH.^2 ...
            +(-(T.FHot.*cpH.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.^2.*L.*pi.*(Tci - Tco - Thi + Tho))).^2 .* dDiH.^2 ...
            +((T.FHot.*rhoH.*log((Tco - Tho)./(Tci - Thi)).*(Thi - Tho))./(DiH.*L.*pi.*(Tci - Tco - Thi + Tho))).^2 .* dcpH.^2 ...
        ) .* strcmp(string(T.flowDir), "Cocurrent")...
    );

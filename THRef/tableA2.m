function A2 = tableA2()
    ...
    A2.T = A2.T + 273.15; % C -> K
    A2.P = A2.P * 1e5; % bar -> Pa
    
    A2.vf = A2.vf * 1e-3; % to m^3/kg
    
    A2.uf = A2.uf * 1e3; % kJ -> J
    A2.ug = A2.ug * 1e3; % kJ -> J
    
    A2.hf = A2.hf * 1e3; % kJ -> J
    A2.hfg = A2.hfg * 1e3; % kJ -> J
    A2.hg = A2.hg * 1e3; % kJ -> J
    
    A2.sf = A2.sf * 1e3; % kJ -> J
    A2.sg = A2.sg * 1e3; % kJ -> J
